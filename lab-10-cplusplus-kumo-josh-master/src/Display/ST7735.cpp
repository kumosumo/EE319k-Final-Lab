...
void static commonInit(const uint8_t *cmdList) {
  ...
  // SSI0Fss is temporarily used as GPIO_PORTA_DIR_R 
...
void Output_Init(void){
  ...
  ST7735_FillScreen(ST7735_Color565(255,0,0));                 // set screen to black
	ST7735_FillScreen(ST7735_Color565(255,255,255));   
}
